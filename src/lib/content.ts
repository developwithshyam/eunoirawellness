export const heroContent = {
  ...
  tickerQuote: {
    text: "I would give 10 stars to Eunoira for being with me",
    author: "Aylani Adam",
  },
};
...
export const missionContent = {
  heading:
    "Eunoira is a passion project of psychologists and counsellors!",
  body: `At Eunoira, we're bringing powerful transformation to individuals in a world where 13% of us need psychological help, and 7 out of 10 individuals' productivity is reduced due to a lack of mental health support. Our mission is to help individuals pursue their lives with greater clarity, purpose, and passion.

Don't know where to start? Eunoira is here to help. Book a psychologist or book a free consultation with one of our Eunoira Care Listeners. We shall guide you on how to proceed and heal yourself.`,
};

export const assessmentStrip = {
  label: "Eunoira Psychologists",
  offer: "30 Minutes, Free Assessment",
  meetLabel: "Book a Google Meet",
...
export const faqItems = [
  {
    question: "Can I have therapy sessions in my preferred language?",
    answer:
      "Yes, you can! Eunoira offers therapy sessions in multiple languages. Speaking in your native language is important and that's a great option. It can help you feel more comfortable and express yourself clearly during your sessions.",
  },
  {
...
export const referContent = {
  heading: "Help Someone.",
  body: "As somebody's dear one you are the first one to reach out when they are in pain. You were there to feel them and were really worried about them. So, now be there to make sure that they get what they actually need — mental health care is the best gift to your loved ones.",
  cta: "Refer a Friend",
};

export const aboutContent = {
  missionHero:
    "Our mission is to make mental health care feel closer, calmer, and more human",
  storyTitle: "Story of a Passion Project",
  storyParagraphs: [
  ...
  leadershipSubtitle:
    "At Eunoira, care is a shared responsibility. Each of us holds a part of the journey — supporting therapists, shaping experiences, and staying close to the people we serve.",
  bottomCta: "Start now for a better tomorrow.",
};
...
export const advisoryBoard = [
  {
    ...
    bio: "With over 10 years of experience, they bring deep expertise in clinical psychology, relationships, and sexual wellness, supporting both individuals and couples through a wide range of emotional and interpersonal challenges.",
  },
  {
    name: "Aswathy Sambath",
    title: "Advisory Board Member",
    bio: "A registered Clinical Psychologist with an M.Phil. and over 8 years of experience, working across individual, relationship, and family therapy with a collaborative and empathetic approach.",
  },
  {
    name: "Dr. Aswathy Balan",
    title: "Advisory Board Member",
    bio: "A certified psychiatrist with over 7 years of clinical experience, bringing a thoughtful and evidence-based approach to mental health care and community awareness.",
  },
  {
    name: "Dr. Thaniya K Leela",
    title: "Advisory Board Member",
    bio: "With a Ph.D. in Psychology and an M.Phil. from UiB, Norway, backed by 7+ years of experience supporting adolescents, women, parents, and couples.",
  },
] as const;
...
export const leadershipTeam = [
  {
    ...
    bio: "Leads therapist training and quality assurance at Eunoira, ensuring every therapist is well-prepared, supported, and consistently delivering high standards of care.",
  },
  {
    name: "Shuhaima Hanna Katti",
    role: "Head of Experience & Quality",
    bio: "Oversees the overall client journey at Eunoira, ensuring every touchpoint feels smooth, caring, and consistent — from first contact to ongoing therapy experience.",
  },
  {
    name: "Athulya O",
    role: "Head of Client Care",
    bio: "Supports all client-facing needs at Eunoira, ensuring every client feels heard, guided, and cared for throughout their journey.",
  },
  {
    name: "Faisal Vysam Purath",
    role: "CEO, Founder",
    bio: "I started Eunoira with a simple hope: to create the kind of support I wish more of us had when life felt heavy, and words were hard to find.",
    isFounder: true,
  },
] as const;

export const contactContent = {
  bookingStrip: "Looking to book a session?",
  philosophyTitle: "Why People Talk?",
  philosophyBody:
    "We talk to survive, form social bonds, help others, manage how others perceive us — and there are definitely more reasons. Let's talk!",
  writeLabel: "Like to write? We would love to read!",
  callLabel: "Need to talk? Talk to the team!",
  whatsappLabel: "Love text? Let's get connected on WhatsApp",
  socialTitle: "Follow us on social media",
  formTitle: "We will be happy to get back to you.",
