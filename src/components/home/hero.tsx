  ...
  return (
    <section className="hero-section hero-compact">
      ...
      <div className="hero-cards-strip">
        ...
        >
          <StaggerContainer className="mx-auto grid max-w-7xl grid-cols-4 gap-1.5 sm:gap-3 lg:gap-5">
            {audienceCards.map((card) => {
              ...
              return (
                <StaggerItem key={card.title} className="min-w-0">
                  <Link
                    href={card.href}
                    className="group flex h-full min-w-0 flex-col items-center rounded-xl border border-sage/10 bg-white p-2 text-center shadow-md shadow-purple-deep/10 transition-all duration-300 hover:-translate-y-1 hover:border-sage/40 hover:shadow-xl hover:shadow-purple-deep/15 sm:rounded-2xl sm:p-4 sm:shadow-lg md:p-5 lg:p-6"
                  >
                    ...
                    <h3 className="w-full text-[11px] leading-tight font-semibold text-purple-deep sm:text-sm md:text-lg lg:text-xl">
                      {card.title}
                    </h3>
                    <p className="mt-0.5 w-full text-[9px] leading-snug text-sage sm:mt-1 sm:text-xs md:text-sm">
                      {card.subtitle}
                    </p>
                  </Link>
                </StaggerItem>
